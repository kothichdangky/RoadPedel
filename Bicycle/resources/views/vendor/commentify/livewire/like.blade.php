<span class="d-inline-flex align-items-center text-muted small">
    <button wire:click="like"
            class="btn btn-link p-0 d-inline-flex align-items-center text-decoration-none {{ $comment->isLiked() ? 'text-success' : 'text-secondary' }}">
      <svg class="me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" width="20" height="20">
          <path
      ...
      <span class="fw-medium text-dark">{{ $count }}</span>
